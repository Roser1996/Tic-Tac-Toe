...
namespace Roser {
    ...
    void GameState::Init() {
        ...
        _gridSprite.setPosition((SCREEN_WIDTH / 2) - (_gridSprite.getLocalBounds().width / 2), (SCREEN_HEIGHT / 2) - (_gridSprite.getLocalBounds().height / 2));
    ...
    void GameState::CheckAndPlacePiece() {
        ...
        sf::FloatRect gridSize = _gridSprite.getLocalBounds();
        sf::Vector2f gapOutOfGrid = sf::Vector2f((SCREEN_WIDTH - gridSize.width) / 2, (SCREEN_HEIGHT - gridSize.height) / 2);
        
        sf::Vector2f gridLocalTouchPos = sf::Vector2f(touchPoint.x - gapOutOfGrid.x, touchPoint.y - gapOutOfGrid.y);
